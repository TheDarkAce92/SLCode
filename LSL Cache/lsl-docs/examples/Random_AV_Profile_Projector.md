---
name: "Random AV Profile Projector"
category: "example"
type: "example"
language: "LSL"
description: "~ RANDOM AV PROFILE PICTURE PROJECTOR v5.4.5 by Debbie Trilling ~"
wiki_url: "https://wiki.secondlife.com/wiki/Random_AV_Profile_Projector"
author: ""
...
**~ RANDOM AV PROFILE PICTURE PROJECTOR v5.4.5 by Debbie Trilling ~**

**Set-up, configuration and operation Help:** [http://wiki.secondlife.com/wiki/Talk:Random_AV_Profile_Projector](http://wiki.secondlife.com/wiki/Talk:Random_AV_Profile_Projector)

**Profile:** [http://wiki.secondlife.com/wiki/User:Debbie_Trilling](http://wiki.secondlife.com/wiki/User:Debbie_Trilling)
...
// 2009-11-24 VD - mod to use  tag, to work around WEB-1383
// 2009-11-26 VD - add fallback to  tag in case the profile changes are reverted
...
// text to 'ShoutOut' when an AV's profile is projected. Text will be preceeded by their name, eg: "'s face is up in lights!"
