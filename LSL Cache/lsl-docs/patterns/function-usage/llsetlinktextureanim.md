...
tags: ["llSetLinkTextureAnim"]
functions_used: ["llSetLinkTextureAnim"]
...
```lsl
llSetLinkTextureAnim(${integer link}, ${integer mode}, ${|integer face,ALL_SIDES,0,1,2,3,4,5,6,7,8|}, ${integer sizex}, ${integer sizey}, ${float start}, ${float length}, ${float rate});
```
