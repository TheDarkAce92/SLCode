...
signature: "key llGetLinkKey(integer linknumber)"
return_type: "key"
sleep_time: ""
energy_cost: "10.0"
wiki_url: 'https://wiki.secondlife.com/wiki/llGetLinkKey'
deprecated: "false"
first_fetched: "2026-03-10"
last_updated: "2026-03-10"
patterns: ["llgetlinkkey"]
---
...
|------|------|-------------|
| `key` | `object_id` | Link number (0: unlinked, 1: root prim, >1: child prims and seated avatars) or a LINK_* flag |
...
- [SL Wiki](https://wiki.secondlife.com/wiki/llGetLinkKey)


<!-- wiki-source -->
_Source: [SL Wiki](https://wiki.secondlife.com/wiki/llGetLinkKey) — scraped 2026-03-18_
