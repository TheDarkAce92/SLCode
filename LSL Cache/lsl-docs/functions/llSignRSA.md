...
signature: "string llSignRSA(string privkey, string message, string alg)"
return_type: "string"
sleep_time: ""
energy_cost: "10.0"
...
- [SL Wiki](https://wiki.secondlife.com/wiki/llSignRSA)


<!-- wiki-source -->
_Source: [SL Wiki](https://wiki.secondlife.com/wiki/llSignRSA) — scraped 2026-03-18_
