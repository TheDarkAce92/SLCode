---
name: "ARCFOUR Strong Encryption Implementation"
category: "example"
type: "example"
language: "LSL"
description: "ARCFOUR Strong Encryption Implementation - Linden Scripting Language (LSL) Version 1.0"
wiki_url: "https://wiki.secondlife.com/wiki/ARCFOUR_Strong_Encryption_Implementation"
author: ""
...
- 5 Code
  ...
  - 5.1 Encryption
  - 5.2 Decryption
  - 5.3 Test Vectors for ARCFOUR

ARCFOUR Strong Encryption Implementation - Linden Scripting Language (LSL)
Version 1.0
...
- Hashes the key and the nonce with MD5, as per the [RSA Laboratories suggestion](http://www.rsa.com/rsalabs/node.asp?id=2009). This prevents all related key attacks against ARCFOUR.
...
Test vectors are from [RC4 Summary](http://www.bookrags.com/wiki/RC4)
