...
```lsl
llSetLinkAlpha(${|integer linknumber,LINK_THIS,LINK_ROOT,LINK_ALL_CHILDREN,LINK_SET,LINK_ALL_OTHERS|}, ${float alpha}, ${|integer face,ALL_SIDES,0,1,2,3,4,5,6,7,8|});
```
