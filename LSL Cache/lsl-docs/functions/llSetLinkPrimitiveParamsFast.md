...
signature: "void llSetLinkPrimitiveParamsFast(integer linknumber, list rules)"
return_type: "void"
sleep_time: ""
energy_cost: "10.0"
...
patterns: ["llsetlinkprimitiveparamsfast"]
---
...
- [SL Wiki](https://wiki.secondlife.com/wiki/llSetLinkPrimitiveParamsFast)


<!-- wiki-source -->
_Source: [SL Wiki](https://wiki.secondlife.com/wiki/llSetLinkPrimitiveParamsFast) — scraped 2026-03-18_
