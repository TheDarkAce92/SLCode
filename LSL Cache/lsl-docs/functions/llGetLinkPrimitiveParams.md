...
signature: "list llGetLinkPrimitiveParams(integer linknumber, list rules)"
return_type: "list"
sleep_time: ""
energy_cost: "10.0"
...
patterns: ["llgetlinkprimitiveparams"]
---
...
|------|------|-------------|
| `integer (link)` | `link` | Link number (0: unlinked, 1: root prim, >1: child prims and seated avatars) or a LINK_* flag to get the parameters of |
...
- [SL Wiki](https://wiki.secondlife.com/wiki/llGetLinkPrimitiveParams)


<!-- wiki-source -->
_Source: [SL Wiki](https://wiki.secondlife.com/wiki/llGetLinkPrimitiveParams) — scraped 2026-03-18_
