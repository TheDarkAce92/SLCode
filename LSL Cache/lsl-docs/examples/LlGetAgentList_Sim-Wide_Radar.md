---
name: "LlGetAgentList Sim-Wide Radar"
category: "example"
type: "example"
language: "LSL"
description: "A simple radar implementation using llGetAgentList. Una implementación simple de un radar utilizando llGetAgentList."
wiki_url: "https://wiki.secondlife.com/wiki/LlGetAgentList_Sim-Wide_Radar"
author: ""
...
A simple radar implementation using llGetAgentList.

Una implementación simple de un radar utilizando llGetAgentList.

## Setup

Simply rez two (or more) prims, link them and put the script in the root. Arrange the links *ad libitum*.

Simplemente rezea dos (o más) prims, enlácelos y ponga el script en la raiz. Arregle los links *ad libitum*.
