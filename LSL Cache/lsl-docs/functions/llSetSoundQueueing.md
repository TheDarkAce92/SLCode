...
signature: "void llSetSoundQueueing(integer queue)"
return_type: "void"
sleep_time: ""
energy_cost: "10.0"
wiki_url: 'https://wiki.secondlife.com/wiki/llSetSoundQueueing'
deprecated: "false"
first_fetched: "2026-03-10"
last_updated: "2026-03-10"
patterns: ["llsetsoundqueueing"]
---
...
|------|------|-------------|
| `integer (link)` | `link` | boolean, sound queuing: TRUE enables, FALSE (default) disables |
| `integer (boolean)` | `queue` |  |
...
- [SL Wiki](https://wiki.secondlife.com/wiki/llSetSoundQueueing)


<!-- wiki-source -->
_Source: [SL Wiki](https://wiki.secondlife.com/wiki/llSetSoundQueueing) — scraped 2026-03-18_
