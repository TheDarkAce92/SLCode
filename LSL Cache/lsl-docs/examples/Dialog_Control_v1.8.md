---
name: "Dialog Control v1.8"
category: "example"
type: "example"
language: "LSL"
description: "// Constants integer lnkDialog = 14001; integer lnkDialogNumericAdjust = 14005; integer lnkDialogNotify = 14004; integer lnkDialogTextBox = 14007;"
wiki_url: "https://wiki.secondlife.com/wiki/Dialog_Control_v1.8"
author: ""
...
checkMenuRequest(integer sender_num, integer num, string str, key id){
    ...
    // Menu management commands
        ...
        integer i;
        integer count = llGetListLength(data);
        for(i=2; i 0) llMessageLinked(requestedNum, responseInt, responseStr, responseKey);
    }
