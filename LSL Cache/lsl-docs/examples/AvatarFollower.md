...
wiki_url: "https://wiki.secondlife.com/wiki/AvatarFollower"
author: ""
...
llSensor - to, in this case, find the nearby person's key given their name

llGetObjectDetails - to, in this case, find out where they are

llTarget - to set a detection target, so we can notice when we're close

llMoveToTarget - to move the attachment (and thereby you) in their direction

**Constants**

AGENT_BY_LEGACY_NAME - used in the llSensor call to avoid accidentally following non-persons