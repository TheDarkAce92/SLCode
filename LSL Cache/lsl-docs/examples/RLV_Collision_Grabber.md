---
name: "RLV Collision Grabber"
category: "example"
type: "example"
language: "LSL"
description: "This script placed in a prim makes that prim a collision detector that tries to force sit the colliding avatar on a set target using RLV."
wiki_url: "https://wiki.secondlife.com/wiki/RLV_Collision_Grabber"
author: ""
...
This script placed in a prim makes that prim a collision detector that tries to force sit the colliding avatar on a set target using RLV.
